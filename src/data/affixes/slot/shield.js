var shield = {
	...
	primary:{
		...
		Block:{min:10,max:10,minl:11,maxl:11},
		AreaDamage:{min:10,max:16,minl:10,maxl:20},
		EliteReduc:{min:8,max:9,minl:10,maxl:11},
		EliteDamage:{min:4,max:7,minl:5,maxl:8},

		LifePerWrath:{min:476,max:1073,minl:1077,maxl:1276},
		WrathRegen:{min:168,max:183,minl:185,maxl:200},

		CostReduc:{min:5,max:7,minl:5,maxl:8/*,mina:5,maxa:8*/},
		CdReduc:{min:4,max:7,minl:5,maxl:8/*,mina:5,maxa:8*/},

		Bleed:{min:[32,300],max:[37,400],minl:[34,300],maxl:[39,400]},
	...
	secondary:{
		...
		GoldFind:{min:29,max:31,minl:32,maxl:35},
		BonusXp:{min:100,max:139,minl:140,maxl:200},
		Globes:{min:14231,max:20000,minl:20001,maxl:29713},
		IgnoreDura:{min:1,max:1/*,minl:1,maxl:1,mina:1,maxa:1*/},
		LevelReduc:{min:2,max:30,minl:2,maxl:30},
		Thorns:{min:1343,max:3180,minl:1525,maxl:3498},
		...
		MaxWrath:{min:4,max:8,minl:6,maxl:10}
	}
};
